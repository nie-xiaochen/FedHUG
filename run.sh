...
################ FedHUG ################
python -u fedhug.py --dataset $dataset --gpu "0" --partition $data_partition --model $model --n_parties $client --sample_fraction $sample_fraction --num_local_iterations $iternum --beta $beta --start_round $start_round --comm_round $comm_round --save_model > $dir_path/fedhug.log
